...
pub struct RangeRequest {
    ...
    pub range_end: ::prost::bytes::Bytes,
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DowngradeVersionTestRequest {
    #[prost(string, tag = "1")]
...
pub struct StatusResponse {
    ...
    #[prost(int64, tag = "12")]
    pub db_size_quota: i64,
    /// downgradeInfo indicates if there is downgrade process.
    #[prost(message, optional, tag = "13")]
    pub downgrade_info: ::core::option::Option<DowngradeInfo>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
