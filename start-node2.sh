...
case "$TCT" in
  ...
  2) TCT_INFIX=""
     echo "start-node2.sh: --tct=2 (Both) is not implemented -- serving the" \
...
NODE_CERT="$CERTS/pem/ExampleDeviceServer.ABC.SNX00002.chain${TCT_INFIX}.pem"
NODE_KEY="$CERTS/key/ExampleDeviceServer.ABC.SNX00002${TCT_INFIX}.key"
