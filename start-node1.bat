...
if "%TCT%"=="0" (
  set "NODE_CERT=%CERTS%\pem\ExampleDeviceServer.ABC.SNX00001.chain.pem"
  set "NODE_KEY=%CERTS%\key\ExampleDeviceServer.ABC.SNX00001.key"
) else if "%TCT%"=="2" (
  set "NODE_CERT=%CERTS%\pem\ExampleDeviceServer.ABC.SNX00001.chain.pem"
  set "NODE_KEY=%CERTS%\key\ExampleDeviceServer.ABC.SNX00001.key"
) else if "%TCT%"=="1" (
  set "NODE_CERT=%CERTS%\pem\ExampleDeviceServer.ABC.SNX00001.chain.ec.pem"
  set "NODE_KEY=%CERTS%\key\ExampleDeviceServer.ABC.SNX00001.ec.key"
) else (
