...
#   start-node1-bare.sh <as-host> <as-port> [<rds-host> <rds-port>] \
...
# to be accepted. Named rather than left as the digit so the block below is
# exhaustive over values this script chose itself.
case "$RAP" in
