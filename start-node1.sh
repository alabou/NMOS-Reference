...
RDS_CLIENT_ARGS=()
for infix in "${TCT_INFIXES[@]}"; do
  NODE_CLIENT_ARGS+=(--nodeClientCertificate "$CERTS/pem/ExampleDeviceClient.ABC.SNX00001.chain${infix}.pem")
  NODE_CLIENT_ARGS+=(--nodeClientKey "$CERTS/key/ExampleDeviceClient.ABC.SNX00001${infix}.key")
